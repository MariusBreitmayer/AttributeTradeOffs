...
We have to note here again, that our mean values are not sales weighted. This might result into biased values, as a car model with lower sales is "overrepresented", while car models with higher sales are "underrepresented".
...
Our correlation coefficient is `0.8058689` and even though our sample is quite small, this sug-gests a strong positive linear relationship. This indicates that if we increased the CAFE Standards, this would result in higher average fuel economy. This would be one way to ex-plain why there was an increase in fuel economy early, which later changed to increasing other characteristics such as for example horsepower. 
...
#< info "level sets"
Level sets are also known as iso-cost curves.
